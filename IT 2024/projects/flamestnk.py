...
if __name__ == "__main__" : 
	...
	Player1_field.grid(row = 1, column = 1, ipadx ="200") 
	Player2_field.grid(row = 2, column = 1, ipadx ="200") 
	Status_field.grid(row = 4, column = 1, ipadx ="200") 
